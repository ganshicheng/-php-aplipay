...
class AlipayService
{
    ...
    public function doPay($totalFee, $outTradeNo, $account,$realName,$remark='')
    {
        ...
        $result = $this->curlPost('https://openapi.alipaydev.com/gateway.do?charset='.$this->charset,$commonConfigs);
        $resultArr = json_decode($result,true);
        $resultArr = $resultArr['alipay_fund_trans_toaccount_transfer_response'];
        return $resultArr;
    }
